...
class TokenBucket:
    ...
    def available(self, client_id: str, now: float | None = None) -> float:
        ...
        # Chặn trần: thiếu bước này thì client im lặng một ngày sẽ tích được
    ...
    def consume(self, client_id: str, now: float | None = None) -> None:
        ...
        # Ghi lại cả ``ts``: quên nó thì lần sau tính phần nạp thêm từ một mốc
        # thời gian đã cũ, và xô tự đầy lại vô tội vạ.
